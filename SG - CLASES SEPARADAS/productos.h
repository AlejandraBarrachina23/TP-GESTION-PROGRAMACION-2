...
void Producto::mostrarProducto(){
    ...
    std::cout << setiosflags(ios::left)<<setw(4)<< stockSucursal<<setw(4)<< stockDeposito <<setw(15)<< rubro <<setw(6); cout.precision(3);
    std::cout << setiosflags(ios::left)<<precioCosto <<setw(6)<< precioVenta<<setw(13)<<proveedor;
    std::cout << setiosflags(ios::left)<<setw(6)<<porcentuales.getIVA()<<setw(6)<<porcentuales.getIB()<<setw(6)<<porcentuales.getPercepcion()<<endl;
    }
}
